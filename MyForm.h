...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->time_exec->Size = System::Drawing::Size(126, 25);
			this->time_exec->TabIndex = 6;
			this->time_exec->Text = L"Velocidade : ";
			// 
			// checkBox1
			// 
			...
			this->convertToGray->Text = L"Escala de cinza";
...
private: System::Void convertToGray_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	time_exec->Text = "Velocidade : "+ time.ToString() + " µs";
